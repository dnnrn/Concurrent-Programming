...
class Quicksort {
    ...
    public static void main(String[] args) {
        ...
        int n = rand.nextInt(990001) + 10000; //n is between 10 000 and 1 000 000, entries in array
        int[] numberArray = new int[n];
        for (int i = 0; i < n; i++) {
            numberArray[i] = 1 + rand.nextInt(1000000); //int at i is between 1 and 1 000 000
        }

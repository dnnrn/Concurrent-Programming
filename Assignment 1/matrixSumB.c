...
//set the first element of the strip as the max/min
 workerMax = matrix[first][0];
 workerMin = matrix[first][0];
 workerMax_X = first, workerMax_Y = 0;/*position of the max value*/
 workerMin_X = first, workerMin_Y = 0;/*position of the min value*/
...
//update the global minmum value and its position 
